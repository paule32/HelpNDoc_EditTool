...
{$WARNINGS ON}
begin
rect.Right := rect.Left + rect.Right + 49 ;
...
begin
  ...
  begin
    ...
    begin
      ...
      MaxWidth := CaptionRect.Right - CaptionRect.Left + 149;
      ...
      begin
        ...
        begin
          Windows.DrawText(Canvas.Handle,
                           ...
                           CaptionRect,
                           DT_CALCRECT or DT_EXPANDTABS or DT_LEFT or DT_SINGLELINE);
          MaxWidth := Max(CaptionRect.Right - CaptionRect.Left + 49, MaxWidth);
        end;
      end;
...
const
  COLOR_MENUBAR = 30;
begin
Arect.Right := Arect.Left + Arect.Right + 49 ;
